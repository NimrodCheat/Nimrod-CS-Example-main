...
namespace Nimrod
{
    public class api
    {
        ...
        /// <summary>
        /// Set up your application credentials in order to use Nimrod
        /// </summary>
        ...
        public api(string name, string ownerid, string secret, string version)
        {
            ...
            {
                error("plz added , name , ownerid , secret ,version ");
                Environment.Exit(0);
            }
        ...
        bool initzalized;
        /// <summary>
        /// Initializes the connection with Nimrod in order to use any of the functions
        /// </summary>
        public void init()
        {
        ...
        /// <summary>
        /// Use Buttons from Nimrod Customer Panel
        /// </summary>
        ...
        /// <summary>
        /// Nimrod acts as proxy and downlods the file in a secure way
        /// </summary>
        ...
        private static string req(NameValueCollection post_data)
        {
            try
            {
                ...
                {
                    var raw_response = client.UploadValues("https://Nimrod.win/api/1.0/", post_data);
            ...
            catch (WebException webex)
            {
                ...
                switch (response.StatusCode)
                {
                    case (HttpStatusCode)429: // client hit our rate limit
                        ...
                        Environment.Exit(0);
                        return "";
                    default: // site won't resolve. you should use Nimrod.uk domain since it's not blocked by any ISPs
        ...
        private static string req_unenc(NameValueCollection post_data)
        {
            try
            {
                using (WebClient client = new WebClient())
                {
                    var raw_response = client.UploadValues("https://Nimrod.win/api/1.1/", post_data);
